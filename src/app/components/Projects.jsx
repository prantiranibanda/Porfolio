...
import Note from "@/../public/note1.png";
				...
				<div className="flex space-x-10 rounded-[4px] bg-zinc-800 p-8">
					...
					<div className="flex flex-col justify-center">
						...
						<div className="pr-8 text-justify text-lg font-light">
							...
							and snakeladder. I used React js and Tailwind CSS and deployed
							using Vercel.
						</div>
						<div className="flex space-x-4">
							...
							<a
								className="cursor-pointer"
								href="https://joy-junction.vercel.app/"
								target="_blank"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
				...
				<div className="flex space-x-10 rounded-[4px] bg-zinc-800 p-8">
					<div className="flex flex-col justify-center pl-8">
						...
						<div className="text-justify text-lg font-light">
							...
							developed using MERN Stack.You can add, edt and delete your note
						...
						<div className="flex space-x-4">
							...
							<a
								className="cursor-pointer"
								href="https://notetake-two.vercel.app/login"
								target="_blank"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
				...
				<div className="flex space-x-10 rounded-[4px] bg-zinc-800 p-8">
					...
					<div className="flex flex-col py-5 justify-center">
						...
						<div className="pr-8 text-justify text-lg font-light">
							...
							<br />
							It is a fullstack webapp created using Next js. A web platform
							enabling users to make custom schedules to revise and practice
							coding at chosen intervals.
						</div>
						<div className="flex space-x-4">
							<a
								className="cursor-pointer"
								href="https://github.com/prantiranibanda/CodeBuddy"
								target="_blank"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<a
								className="cursor-pointer"
								href="https://yourcodebuddy.vercel.app/"
								target="_blank"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
