			...
			<div className="space-y-16 px-52 pt-16 text-white">
				<div className="flex space-x-10 bg-zinc-800 p-8">
					<Image
						...
						width={400}
						height={400}
						className="rounded-sm bg-zinc-900 p-4 opacity-60 hover:opacity-100"
					/>
					<div className="flex flex-col justify-center">
						<div className="abel-regular py-2 text-4xl text-zinc-500">
							Joy-Junction
						</div>
						<div className="">
							<span className="abel-regular-thin text-2xl text-zinc-400">
								A simple webgame
							</span>
				...
				<div className="flex space-x-10 bg-zinc-800 p-8">
					<div className="flex flex-col justify-center pl-8">
						<di className="abel-regular py-2 text-4xl text-zinc-500">
							iNotebook
						</di>
						<div className="">
							<span className="abel-regular-thin text-2xl text-zinc-400">
							...
							developed using MERN Stack.You can add, edt and delete your note as per the requirement.
						</div>
						<div className="flex space-x-3">
							<svg
								xmlns="http://www.w3.org/2000/svg"
