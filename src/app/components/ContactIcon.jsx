...
const ContactIcon = () => {
	return (
		<div className="space-x-8 pt-8 text-white">
			<Link href="https://github.com/prantiranibanda">
			...
			<Link href="https://www.instagram.com/prantiranibanda">
			...
			<Link href="https://www.facebook.com/prantiranibanda">
			...
			<Link href="https://x.com/prantiranibanda">
