...
const About = () => {
  return (
    <div>
      <div className="text-white text-center abel-regular bg-gradient-to-r from-[#0c0c0c] via-[#212020] to-[#0c0c0c] py-7 text-8xl mb-20">About Me</div>
      <div className="flex px-40 space-x-14 text-justify abel-regular-thin text-2xl text-white">
        <div className="w-1/2">
          ...
          <div className="pt-2 pb-10"> C, C++,Java, JavaScript, Python, HTML5, CSS3</div>
          <div className="text-gray-400 abel-reguler text-3xl pb-1 w-fit border-b-2 border-[#ff014f]">Databases:</div>
          <div className="pt-2 pb-10"> SQL, MySQL, MongoDB</div>
          <div className="text-gray-400 abel-reguler text-3xl pb-1 w-fit border-b-2 border-[#ff014f]">Frameworks:</div>
          <div className="pt-2 pb-10"> React JS, Node JS, Express JS</div>
          <div className="text-gray-400 abel-reguler text-3xl pb-1 w-fit border-b-2 border-[#ff014f]">Tools & Technologies:</div>
          <div className="pt-2 pb-10"> Git, Github</div>
        </div>
        <div className="w-1/2">
          <div className="pb-5">
            I am a undergrad student at Techno Main Salt Lake pursuing btech in the field of Information Technology.I have started my web development journey and created several websites using ReactJS, NextJS and other JS frameworks alongwith some CSS frameworks like Tailwind.
          </div>
          <div className="pb-5">
