	...
	return (
		<div id="about" >
			...
			<div className="abel-regular-thin flex space-x-14 px-40 text-justify text-2xl text-white">
				<div className="w-1/2">
					<div className="abel-reguler w-fit border-b-2 border-[#ff014f] pb-1 text-2xl text-gray-400">
						Languages:
					</div>
					<div className="pb-5 pt-2 text-[20px] text-red-300">
						{" "}
					...
					<div className="pb-5 pt-2 text-[20px] text-red-300"> Git, Github</div>
				</div>
